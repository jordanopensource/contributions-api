...
const ConnectToDB = async () => {
  ...
  if(process.env.NODE_ENV !== 'dev'){
    ...
    DB_URL = 'mongodb+srv://'+process.env.DATABASE_USER+':'+process.env.DATABASE_PASSWORD+'@'+process.env.DATABASE_HOST+":"+process.env.DATABASE_PORT+'/'+process.env.DATABASE_NAME;
  }
